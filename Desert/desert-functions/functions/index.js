...
لقد وصلك هذا التنبيه لأن ${userName} قام بإضافتك مسبقًا كجهة اتصال للسلامة في تطبيق سهيل.

قبل بدء رحلته، قام ${userName} بتسجيل رحلة في تطبيق سهيل وحدد موعدًا متوقعًا للعودة. وبما أن موعد العودة قد مرّ ولم نتلقَّ أي تحديث حديث للموقع، فإننا نشارك معك آخر المعلومات المتاحة.
...
ننصح بمحاولة التواصل مع المسافر أولًا. وفي حال تعذر الوصول إليه، يمكن التواصل مع الجهات المختصة على الرقم 911.
